...
\section{Approach}
The reference paper by Yamni et al. \cite{yamni202efficient} combines three transforms to encrypt and embed an image as a binary watermark into the low frequency components of an audio signal. We replicate their method and analyze its performance under various attacks.
...
\begin{enumerate}
	...
	\item \textbf{Random Time Scaling by $\pm 10\%$: } We randomly speed up or slow down the watermarked audio by up to 10\%.
...
Time Scale $\pm 10\%$ & -1.457	& -38.571	& 0.499	& 0.002	& 5.313	& 0.002\\
...
\begin{figure}[h!]
	...
	\end{subfigure}
	\label{fig:Insert the Reference Tag}
\end{figure}
...
This means that the low performance of the watermarking method is not the primary issue, as pirates or other opposition parties would be unlikely to use such low-quality audio.
\newpage
